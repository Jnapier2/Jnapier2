...
- [Image Downloader](https://github.com/Jnapier2/image-downloader) — The 2026.08.02.1 release collects permitted images with controlled discovery, a five-second per-image network budget, credential-safe evidence, Windows-safe filenames, resumable state, duplicate controls, and atomic finalization.
